 ...
 * @since  0.0.1
 */
class JoomSquadsViewachievement_list extends JViewLegacy {

    /**
     * Display the JoomSquads admin squad list view
     *
    ...
    protected function addToolBar() {
        JToolBarHelper::title(JText::_('COM_JOOMSQUADS_ACHIEVEMENTS_TITLE'));
        JToolBarHelper::addNew('achievement.add');
        JToolBarHelper::editList('achievement.edit');
        JToolBarHelper::deleteList('', 'achievement_list.delete');
    }

    protected function addSideBar() {
        require_once JPATH_COMPONENT . '/helpers/joomsquads.php';
        JoomSquadsHelper::addSubmenu('achievement_list');
    }
