 ...
 * @since  0.5.0
 */
class JoomSquadsControllerApplication_list extends JControllerAdmin {
     ...
     * @since   1.6
     */
    public function getModel($name = 'application', $prefix = 'JoomSquadsModel'/* , $config = array('ignore_request' => true) */) {
