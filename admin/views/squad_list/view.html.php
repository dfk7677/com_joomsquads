 ...
 * @since  0.0.1
 */
class JoomSquadsViewsquad_list extends JViewLegacy
{
	/**
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::addNew('squad.add');
		JToolBarHelper::editList('squad.edit');
		JToolBarHelper::deleteList('', 'squad_list.delete');
	}
	
	protected function addSideBar()
	{
		require_once JPATH_COMPONENT . '/helpers/joomsquads.php';
		JoomSquadsHelper::addSubmenu('squad_list');
	}
