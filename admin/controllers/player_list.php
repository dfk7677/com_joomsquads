 ...
 */
 ...
 class JoomSquadsControllerplayer_list extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'player', $prefix = 'JoomSquadsModel'/*, $config = array('ignore_request' => true)*/)
	{
